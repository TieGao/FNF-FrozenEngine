...
{
	public static var frozenEngineVersion:String = '0.1.1';
	...
	override function create()
	{
		...
		frozenVer.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(frozenVer);
