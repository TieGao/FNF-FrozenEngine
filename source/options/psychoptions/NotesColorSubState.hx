...
class NotesColorSubState extends MusicBeatSubstate
{
	...
	public function new() {
		...
		tip.setFormat(Paths.font("montserrat.ttf"), 16, FlxColor.WHITE, LEFT, OUTLINE, FlxColor.BLACK);
		tip.borderSize = 2;
		add(tip);

		tipTxt = new FlxText(tipX, tipY + 24, 0, '', 16);
		tipTxt.antialiasing = ClientPrefs.data.antialiasing;
		tipTxt.setFormat(Paths.font("montserrat.ttf"), 16, FlxColor.WHITE, LEFT, OUTLINE, FlxColor.BLACK);
		tipTxt.borderSize = 2;
		add(tipTxt);
		updateTip();
